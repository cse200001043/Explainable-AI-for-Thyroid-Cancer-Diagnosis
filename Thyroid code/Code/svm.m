...
%   Model =  fitcsvm(dataTrain,outTrain, 'KernelFunction', 'linear');
%  Model =  fitcsvm(dataTrain,outTrain, 'KernelFunction', 'polynomial');
 % Model =  fitcsvm(dataTrain,outTrain, 'KernelFunction', 'polynomial', PolynomialOrder = 3);
%Model =  fitcsvm(dataTrain,outTrain, 'KernelFunction', 'rbf', 'BoxConstraint',1, 'KernelScale','auto','Standardize',true);
%   Model =  fitcsvm(dataTrain,outTrain, 'KernelFunction','mysigmoid','Standardize',true);
